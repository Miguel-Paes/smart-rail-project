...
<template>
  ...
  <v-row class="d-flex">
    <v-col class="d-flex flex-column justify-center" cols="12" md="6">
      <v-row
        class="d-flex"
        :class="displayStore.xs ? '' : displayStore.sm ? '' : 'ga-3'"
        dense
      >
        ...
        <v-col cols="12">
          <v-card variant="tonal">
            ...
            >
              <thead>
                <tr>
                  <th class="text-left bg-transparent">Nome</th>
                  <th class="text-left bg-transparent">Próx. Parada</th>
                  <th class="text-left bg-transparent">Destino Final</th>
                </tr>
              </thead>
              <tbody>
