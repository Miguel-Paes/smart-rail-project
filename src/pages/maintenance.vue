...
import TrainsList from "@/components/MaintenancePage/TrainsList.vue";
    ...
    <v-card class="pa-3 d-flex ga-3 mb-3">
      <v-row>
        <v-col cols="12" xs="6" sm="4">
          <v-card class="pa-3">
            <TrainsList :items="operatingTrains" title="Trens Operando" />
          </v-card>
        </v-col>

        <v-col cols="12" xs="6" sm="4">
          <v-card class="pa-3">
            <TrainsList :items="inoperativeTrains" title="Trens Estacionados" />
          </v-card>
        </v-col>
